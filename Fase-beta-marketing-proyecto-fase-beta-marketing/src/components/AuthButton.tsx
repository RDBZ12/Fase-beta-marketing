    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 py-10 font-['Inter',_sans-serif] bg-[radial-gradient(120%_120%_at_20%_0%,_#3A28B8_0%,_#1D1266_45%,_#0E0A32_100%)]">
      ...
      />
        ...
        <div className="relative z-10 w-full max-w-[400px] rounded-[24px] border border-[rgba(255,255,255,0.22)] bg-[rgba(255,255,255,0.09)] px-[36px] pb-[32px] pt-[40px] shadow-[0_20px_60px_rgba(10,6,40,0.45)] backdrop-blur-[22px]">
          ...
          <>
            <div id="tour-login-brand" className="mb-[26px] flex flex-col items-center gap-[10px]">
              <div
            ...
            <h1 className="mb-1 font-['Manrope',_sans-serif] text-[22px] font-bold text-white text-center">Bienvenido</h1>
            <p className="mb-6 text-[13px] leading-[1.5] text-[rgba(255,255,255,0.62)] text-center">
              Accede a tu panel de campañas y marketing con IA.
            </p>

            <div id="tour-login-client-checklist" className="w-full bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-2xl p-5 mb-6 text-left">
              <ul className="space-y-4">
                {[
                  'Haz clic en "Continuar con Google"',
                  'Selecciona tu cuenta de Google',
                  'Si es tu primera vez, crearemos tu perfil',
                  'Si ya tienes cuenta, iniciaremos sesión'
                ].map((text, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <div className="mt-0.5 w-5 h-5 rounded-full bg-[#33D9C7]/20 border border-[#33D9C7]/40 flex items-center justify-center shrink-0">
                      <svg className="w-3.5 h-3.5 text-[#33D9C7]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <span className="text-[13px] text-[rgba(255,255,255,0.85)] leading-snug">{text}</span>
                  </li>
                ))}
              </ul>
            </div>
